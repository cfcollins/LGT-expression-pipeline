...
write.csv(results_edit, "004-degenerating_categorisation_1_LGTvsNativevsDonor/06-LGTs_less_than_native_and_donor/02-top_gene_all/LGTs_less_than_native_and_donor_or_not-TOP-GENE-ALL.csv", row.names = FALSE)
...
write.csv(full, "004-degenerating_categorisation_1_LGTvsNativevsDonor/06-LGTs_less_than_native_and_donor/02-top_gene_all/silenced_lower_vs_not_top_gene_all.csv", row.names = FALSE)  
...
write.csv(summary, "004-degenerating_categorisation_1_LGTvsNativevsDonor/06-LGTs_less_than_native_and_donor/02-top_gene_all/summary_stats_LGT_nat_don_TOP_GENE_ALL.csv", row.names = FALSE)
