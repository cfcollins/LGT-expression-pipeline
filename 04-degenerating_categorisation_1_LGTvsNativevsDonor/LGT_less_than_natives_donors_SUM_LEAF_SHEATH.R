...
write.csv(results_edit, "004-degenerating_categorisation_1_LGTvsNativevsDonor/06-LGTs_less_than_native_and_donor/03-sum_leaf_sheath/LGTs_less_than_native_and_donor_or_not-SUM-LEAF-SHEATH.csv", row.names = FALSE)
...
write.csv(full, "004-degenerating_categorisation_1_LGTvsNativevsDonor/06-LGTs_less_than_native_and_donor/03-sum_leaf_sheath/silenced_lower_vs_not_sum_leaf_sheath.csv", row.names = FALSE)  
...
write.csv(summary, "004-degenerating_categorisation_1_LGTvsNativevsDonor/06-LGTs_less_than_native_and_donor/03-sum_leaf_sheath/summary_stats_LGT_nat_don_SUM_LEAF_SHEATH.csv", row.names = FALSE)
