...
setwd("003-LGT_vs_native_expression/05-top_gene_leaf_sheath/")
...
write.csv(results, "t-test_results_diff_top_gene_leaf_sheath.csv", row.names = FALSE)
sig <- results %>% 
...
ggsave("LGT_vs_natives_top_gene_leaf_sheath.png", dpi = 1200)

write.csv(counts_combined_columns, "top_gene_leaf_sheath_sig_marked.csv", row.names = FALSE)
