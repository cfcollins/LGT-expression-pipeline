...
setwd("003-LGT_vs_native_expression/04-sum_leaf_sheath/")
...
write.csv(results, "t-test_results_diff_sum_leaf_sheath.csv", row.names = FALSE)
sig <- results %>% 
...
ggsave("LGT_vs_natives_sum_leaf_sheath.png", dpi = 1200)

write.csv(counts_combined_columns, "sum_leaf_sheath_sig_marked.csv", row.names = FALSE)
